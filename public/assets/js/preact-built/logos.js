(() => {
  ...
  // ns-hugo-imp:/home/diogocgodoi/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260527025321-61f41d3667f1/blox/shared/js/components/Icon.jsx
  ...
  // ns-hugo-imp:/home/diogocgodoi/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260527025321-61f41d3667f1/blox/logos/component.jsx
  var MARQUEE_CSS = `
...
`;
  var SLOT_W = { sm: "w-24", md: "w-32", lg: "w-40" };
  var MAX_W = { sm: "3.5rem", md: "5rem", lg: "7rem" };
  var HEIGHT = { sm: "1.75rem", md: "2.5rem", lg: "3.5rem" };
  var FILTER = {
  ...
  function renderText(text) {
    if (!text) return "";
    return String(text).replace(/\*\*(.*?)\*\*/g, "<strong>$1</strong>").replace(/\*(.*?)\*/g, "<em>$1</em>");
  }
  function LogoItem({ item, idx, logoStyle, logoSize, icon_svgs, item_images, padY = "py-3" }) {
    ...
    if (iconSvg) {
      ...
      visual = /* @__PURE__ */ u2("span", { class: "font-semibold text-gray-400 dark:text-gray-500 text-sm", children: item.name });
    } else {
      return null;
    }
    ...
    return item.url ? /* @__PURE__ */ u2("a", { href: item.url, class: cls, "aria-label": item.name || void 0, ...isExt ? { target: "_blank", rel: "noopener noreferrer" } : {}, children: visual }) : /* @__PURE__ */ u2("div", { class: cls, role: "img", "aria-label": item.name || void 0, children: visual });
  }
  function LogoRow({ items, logoStyle, logoSize, icon_svgs, item_images }) {
    return /* @__PURE__ */ u2("div", { class: "flex flex-wrap items-center justify-center", children: items.map((item, i2) => /* @__PURE__ */ u2(LogoItem, { item, idx: i2, logoStyle, logoSize, icon_svgs, item_images }, i2)) });
  }
  function LogoGrid({ items, logoStyle, logoSize, icon_svgs, item_images }) {
    const cols = items.length <= 3 ? "grid-cols-3" : items.length <= 4 ? "grid-cols-2 sm:grid-cols-4" : items.length <= 6 ? "grid-cols-3 sm:grid-cols-6" : "grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6";
    return /* @__PURE__ */ u2("div", { class: `grid ${cols} gap-6 items-center`, children: items.map((item, i2) => /* @__PURE__ */ u2(LogoItem, { item, idx: i2, logoStyle, logoSize, icon_svgs, item_images }, i2)) });
  }
  function LogoMarquee({ items, logoStyle, logoSize, icon_svgs, item_images, speed }) {
    const doubled = [...items, ...items];
    return /* @__PURE__ */ u2(S, { children: [
      /* @__PURE__ */ u2("style", { children: MARQUEE_CSS }),
      /* @__PURE__ */ u2("div", { class: "overflow-hidden", style: "mask-image: linear-gradient(to right, transparent, black 8%, black 92%, transparent)", children: /* @__PURE__ */ u2("div", { class: "hbx-logos-track flex w-max items-center", style: `--hbx-marquee-dur:${speed ?? 30}s`, children: doubled.map((item, i2) => /* @__PURE__ */ u2(
        LogoItem,
        {
          item,
          idx: i2 % items.length,
  ...
  var LogosBlock = ({ content = {}, design = {}, icon_svgs = {}, item_images = {} }) => {
    ...
    return /* @__PURE__ */ u2("div", { class: "py-12 sm:py-16 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ u2("div", { class: "max-w-7xl mx-auto", children: [
      (title || subtitle) && /* @__PURE__ */ u2("div", { class: "text-center mb-8", children: [
        title && /* @__PURE__ */ u2(
          "p",
          {
        ...
        subtitle && /* @__PURE__ */ u2("p", { class: "text-sm text-gray-400 dark:text-gray-500", dangerouslySetInnerHTML: { __html: renderText(subtitle) } })
      ] }),
      layout === "marquee" && /* @__PURE__ */ u2(LogoMarquee, { items: rawItems, logoStyle, logoSize, icon_svgs, item_images, speed }),
      layout === "grid" && /* @__PURE__ */ u2(LogoGrid, { items: rawItems, logoStyle, logoSize, icon_svgs, item_images }),
      layout !== "marquee" && layout !== "grid" && /* @__PURE__ */ u2(LogoRow, { items: rawItems, logoStyle, logoSize, icon_svgs, item_images }),
      cta?.text && cta?.url && /* @__PURE__ */ u2("div", { class: "mt-6 text-center", children: /* @__PURE__ */ u2(
        "a",
        {
          href: cta.url,
  ...
  function renderLogosBlocks() {
    ...
    blocks.forEach((block) => {
      ...
      if (propsData) {
        ...
        R(/* @__PURE__ */ u2(LogosBlock, { ...props }), block);
      }
    });
  }
  renderLogosBlocks();
